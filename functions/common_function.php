...
<div class='row'>
    ...
    <div class='col-md-6'>
    <img src='./admin_area/product images/$product_image2' class='card-img-top' alt=''>
    </div>
    <div class='col-md-6'>
    <img src='./admin_area/product images/$product_image3' class='card-img-top' alt=''>
        </div>
</div>
</div>";
}
      ...
      if(!isset($_GET['my_orders'])){
        if(!isset($_GET['delete_account'])){
          ...
          if($row_count>0){
            ...
            <p class='text-center'><a href='../index.php'>Explore Details</a></p>";
          }
        }
      }
    }
