...
<div class="container mt-5">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-otline w-50 m-auto mb-4">
        ...
        <div class="form-otline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_description" value="<?php echo $product_description;  ?>"name="product_description" 
            class="form-control" required="required">
        </div>
        <div class="form-otline w-50 m-auto mb-4">
        ...
        <div class="form-otline w-50 m-auto mb-4">
            ...
            <IMG SRC="./product images/<?php echo $product_image1 ?>" class="product_img">
            </div>
        </div>
        <div class="form-otline w-50 m-auto mb-4">
            ...
            class="form-control w-90 m-auto" required="required">
            <IMG SRC="./product images/<?php echo $product_image2 ?>" class="product_img">
            </div>
        </div>
        <div class="form-otline w-50 m-auto mb-4">
            ...
            class="form-control w-90 m-auto" required="required">
            <IMG SRC="./product images/<?php echo $product_image3 ?>" class="product_img">
            </div>
        </div>
        <div class="form-otline w-50 m-auto mb-4">
