...
<div class="container">
    <div class="row">
        ...
        <div class="d-flex mb-5">
            ...
            <button class='bg-info px-3 py-2 border-0 text-light'><a href='./users_area/checkout.php' class='text-light text-decoration-none'>Checkout</a></button>";
            }else{
            ...
            <a href="index.php"><button class="bg-success px-3 py-2 mx-3 border-0">Continue shopping</button></a>
            <a href="index.php"><button class="bg-info px-3 py-2 border-0 text-light">Checkout</button></a> -->
        </div>
    </div>
</div>
</form>
